...
CNA enriched but not specific to each subgroup... why?
gene mutation alone did not determine phenotype: interplay between genetic and epigenetic factors

cell of origin have unique epigenetic landscape
provides context in which genetic mutations exert effects

\gene{MYC} expression is high in WNT and Group3

MYCN amplification in SHH & Group4 and MYC amplification in Group3
different roles for MYCN and MYC?
why is MYC amplification enriched in Group3?
SHH has mechanism to eleveate it? via GLI?
what about Group4? Why only MYCN and not MYC amplification?
other activated pathways cooperate with MYC but not MYCN?
...
Cell-of-origin chromatin organization shapes the mutational landscape of cancer \citeref{polak15}.

In summary, medulloblastoma subgroups are characterized by distinct genomic aberrations that dysregulated disparate signaling pathways. 
